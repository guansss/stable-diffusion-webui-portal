...
export function AppBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 pb-12 group">
      <div className="flex flex-wrap bg-background p-2 gap-2 z-10 -translate-y-full transition-[transform,box-shadow] group-hover:shadow-lg group-hover:translate-y-0">
        <Button
          variant="outline"
